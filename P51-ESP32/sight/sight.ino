  ...
  while (Serial1.available() >= 6) {
    ...
    if (Serial1.read() == '$' && Serial1.read() == 'M' && Serial1.read() == '>') {
      ...
      if (cmd == 108) { // ATTITUDE + HEADING
        ...
        altitude = altCm * 0.0328084; // cm to feet
...
void loop() {
  ...
  // Broadcast frequency synced to gauge refresh
  if (millis() - lastBroadcast > 50) {
    Serial0.print("ROL:"); Serial0.print(roll); Serial0.print(",");
    Serial0.print("PIT:"); Serial0.print(pitch); Serial0.print(",");
    Serial0.print("HED:"); Serial0.print(heading); Serial0.print(",");
    Serial0.print("ALT:"); Serial0.print(altitude);Serial0.print(",");
    Serial0.print("BAT:"); Serial0.print(vBat); Serial0.print(",");
    Serial0.print("GFO:"); Serial0.print(currentG);Serial0.print(",");
    Serial0.print("WAR:"); Serial0.println(warActive ? 1 : 0); // 1 = High Brightness, 0 = Dim
